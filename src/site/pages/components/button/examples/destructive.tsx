...
const variantClass = {
  solid: tw("border-transparent bg-danger text-white hover:bg-danger/90 disabled:hover:bg-danger"),
  outline: tw(
    "border-danger bg-transparent text-danger hover:bg-danger/10 disabled:hover:bg-transparent",
  ),
  soft: tw(
    "border-transparent bg-danger/10 text-danger hover:bg-danger/15 disabled:hover:bg-danger/10",
  ),
} as const;
